        ...
        <div id="investigator_function">
          ...
          <div id = backstory>  
            ...
            <div id="appearance">
              ...
              <textarea class="backstory_contents" name="appearance" placeholder="여기에 입력" value={text}></textarea>
            </div>
            <div id="p">
              <p class="backstory_name">성격</p>
              <textarea class="backstory_contents" name="personality" placeholder="여기에 입력" value={text}></textarea>
            </div>
            <div id="relationship">
              <p class="backstory_name">관계</p>  
              <textarea class="backstory_contents" name="relationship" placeholder="여기에 입력" value={text}></textarea>
            </div>

            <div id="etc">
              <p class="backstory_name">기타</p>
              <textarea class="backstory_contents" name="etc" placeholder="여기에 입력" value={text}></textarea>
            </div>

            <div id="belief">
              <p class="backstory_name">신념/사상</p>
              <textarea class="backstory_contents" name="belief" placeholder="여기에 입력" value={text}></textarea>
            </div>

            <div id="location">
              <p class="backstory_name">장소</p>
              <textarea class="backstory_contents" name="location" placeholder="여기에 입력" value={text}></textarea>
            </div>

            <div id="phobia">
              <p class="backstory_name">공포증과<br>집착증</p>
              <textarea class="backstory_contents" name="phobia" placeholder="여기에 입력" value={text}></textarea>
            </div>

            <div id="experience">
              <p class="backstory_name">이상한<br>경험</p>
              <textarea class="backstory_contents" name="experience" placeholder="여기에 입력" value={text}></textarea>
            </div>

            <div id="spell">
              <p class="backstory_name">신화서 주문 유물</p>
              <textarea class="backstory_contents" name="spell" placeholder="여기에 입력" value={text}></textarea>
            </div>
          </div>
        </div>
